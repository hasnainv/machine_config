...
" All of your Plugins must be added before the following lin" e
...
set shiftwidth=2
set autoindent
" Change tabstop for current project from 4 to 2
...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" Swap CAPS-LOCK and ESC; map jj to ESC
...
set makeprg=ninja\ -C\ /proj/janus/build/tmpbuild
set mouse=a
set pastetoggle=<F12>

"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
" ctags config. TODO: Add auto ctag compile map key
"
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
